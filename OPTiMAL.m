...
ancient=csvread('ds01_updated_global_coretop_tex_revised_011226_test.csv',1,0); %If your csv does not contain a header row, remove ,1,0 leaving only the filename (in single quotes) in the parentheses
...
OPTiMAL_Results='OPTiMAL_coretop_v2.csv'; % csv file containing original GDGT data plus Nearest Neighbour distance, SST prediction, and 1 StDev
